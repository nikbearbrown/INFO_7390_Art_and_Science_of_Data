...
- [1. Surveys](#1-surveys)
- [2. Individual Treatment Effects](#2-individual-treatment-effects)
  - [2.1 Heterogeneous Treatment Effects](#21-heterogeneous-treatment-effects)
  - [2.2 Static Data](#22-static-data)
  - [2.3 Temporal Data](#23-temporal-data)
- [3. Representation Learning](#3-representation-learning)
- [4. Semiparametric / Double Robust Inference](#4-semiparametric--double-robust-inference)
- [5. Policy Learning / Causal Discovery](#5-policy-learning--causal-discovery)
- [6. Causal Recommendation](#6-causal-recommendation)
- [7. Causal Reinforcement Learning](#7-causal-reinforcement-learning)
- [Miscellaneous](#miscellaneous)

## 1. Surveys
Content related to comprehensive surveys in the field of Causal AI.

## 2. Individual Treatment Effects
Exploration of individual treatment effects, including methodologies and applications.

### 2.1 Heterogeneous Treatment Effects
Studies and papers focusing on the variability of treatment effects across individuals.

### 2.2 Static Data
Research dealing with static datasets in causal analysis.

### 2.3 Temporal Data
Resources on causal inference using temporal or time-series data.

## 3. Representation Learning
Insights into representation learning within the context of causal inference.

## 4. Semiparametric / Double Robust Inference
Advancements in semiparametric inference and double robust methods for causal analysis.

## 5. Policy Learning / Causal Discovery
Frameworks and algorithms for policy learning and causal discovery in AI systems.

## 6. Causal Recommendation
Approaches to integrating causal inference in recommendation systems.

## 7. Causal Reinforcement Learning
Incorporating causal reasoning into reinforcement learning models and strategies.
